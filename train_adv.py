...
if __name__ == '__main__':
    ...
    parser.add_argument('--train_file', dest='train_file', type=str,
                        default='/home/liu1769/scratch/data_eng__french/train_l_10000.pkl', help='path to training file')
    parser.add_argument('--train_ul_file', dest='train_ul_file', type=str,
                        default='/home/liu1769/scratch/data_eng__french/train_ul_10000.pkl',
    ...
    parser.add_argument('--adv_epochs', dest='adv_epochs', type=int, default=50, help='number of epochs in the outer loop to run during adv training')
